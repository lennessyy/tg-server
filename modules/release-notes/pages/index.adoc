...
* **xref:{page-component-version}@tigergraph-server:backup-and-restore:configurations.adoc#_backup_to_azure_blob[Backup to Azure Blob containers]**
...
xref:{page-component-version}@tigergraph-server:system-management:management-commands.adoc#_gadmin_config_apply[restart only those services]
