...
TigerGraph Server 4.1.1 was released on November 8, 2024.
...
* [4.1.1] **xref:{page-component-version}@tigergraph-server:troubleshooting:audit-log.adoc#_gsql_service_audit_logs[More detailed information in audit logs]**. Also, an authorized admin user can configure the audit logs to include PII.
...
==== Kubernetes
* Fixed inability to run gcollect on a k8s EKS cluster (TP-6291).
