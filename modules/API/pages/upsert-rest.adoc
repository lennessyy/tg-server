...
==== New format (Multi-Edges with JSON arrays):
...
NOTE: 
* The new format allows upserting multiple edges with different discriminator values between the same vertices.
* Regular edges do not support this format.
