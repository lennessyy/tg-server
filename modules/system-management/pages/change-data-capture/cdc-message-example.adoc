...
The following example also illustrates updates to List and Map attribute types.

[NOTE]
====
The CDC format for a map of list values has changed in v4.1.1.
The previous format was
[.json]
----
{ "keyA":1, "keyA":2, "keyB":3, "keyB::4] }
----
The new format is
[.json]
----
...
----
{
    ...
    "content": {
        "attr_list_tuple": {
            "op": "Add",
            "value": [
                2, 0, 3, 3, 1222819200, 0, m2
            ]
        },
        "attr_map_tuple": {
            "op": "ReplaceOrAdd",
            "value": {
                "i":[2,0], "f":[3,3], "b":[122281920, 314159]
            }
        }
    }
}
