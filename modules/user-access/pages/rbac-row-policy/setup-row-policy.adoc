...
See our documentation on xref:{page-component-version}@gsql-ref:tutorials:gsql-101/load-data-gsql-101.adoc[Load Data] and xref:{page-component-version}@gsql-ref:tutorials:gsql-101/define-a-schema.adoc[Define a Schema] in the xref:{page-component-version}@gsql-ref:tutorials:gsql-101/index.adoc[] tutorial.
