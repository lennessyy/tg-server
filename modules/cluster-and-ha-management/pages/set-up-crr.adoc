...
For setting up a new DR cluster after failover, refer to
xref:tigergraph-server:cluster-and-ha-management:fail-over.adoc#_set_up_a_new_dr_cluster_after_failover[].
