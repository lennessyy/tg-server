...
|System.CrossRegionReplication.TopicPrefix |The prefix of GPE/GUI/GSQL Kafka Topic, by default is empty.For details of what it does and how it is used, please refer to xref:tigergraph-server:cluster-and-ha-management:set-up-crr.adoc[].|`nan`
