...
|System.CrossRegionReplication.TopicPrefix |The prefix used for replicated internal topics in the DR cluster. It determines whether the original or replicated topics (with the "primary." prefix) are used. |`nan`
